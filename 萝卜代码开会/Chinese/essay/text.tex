...
\begin{algorithm}[H]
	...
	t$\gets$1(\mathcal{initialization})\;
...
%		\centering
%		\includegraphics[width=1in]{pic/1Ackley32}
%		\caption{fig1}
%		\label{fig:side:a}
%	\end{minipage}
%	\begin{minipage}[t]{0.5\linewidth}
%		\centering
%		\includegraphics[width=1in]{pic/1Ackley2}
%		\caption{fig2}
%		\label{fig:side:b}
%	\end{minipage}
%
...
%\begin{figure}[htbp]
%	\centering
%	\includegraphics[width=\linewidth]{pic/Ackley1}
%	\caption{函数Ackley的收敛结果对比}
%	\label{fig:Ackley}
%\end{figure}
...
第一组(函数变量维数D=10，种群规模N=20，最大迭代次数T=1000)实验结果见下表(\ref{tab5})(\ref{tab6})
...
\end{table}%
\newpage
第二组(函数变量维数D=30，种群规模N=80，最大迭代次数T=1000)实验结果如下表(\ref{tab7})(\ref{tab8})：
